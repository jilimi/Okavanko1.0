...
{
    public class FindGeometryByValue_Copy : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the GetGeometryByValue class.
        /// </summary>
        public FindGeometryByValue_Copy()
        ...
        {
            m_attributes = new ButtonAttribute(this,ClickMe, "Hello");
        }
        public void ClickMe(IGH_Component Component)
        {
            System.Windows.Forms.MessageBox.Show(Component.Name);
        }
        //委托只要传入参数一样即可
        /// <summary>
        ...
        {
            get { return new Guid("DEA109BC-E021-4356-B8B1-322A4C5C5B56"); }
        }
    }
}