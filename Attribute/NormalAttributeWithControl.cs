...
{
    class NormalAttributeWithControl : GH_ComponentAttributes
    {
        protected List<HuControl> ControlList = new List<HuControl>();
        protected IGH_Component Component;
        protected int ControlNumber = 0;
        protected AttributeUtil AttributeUtil;
