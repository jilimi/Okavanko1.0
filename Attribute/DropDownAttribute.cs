...
namespace CSCECDEC.Okavango.Attribute
{
    class DropDownAttribute:GH_ComponentAttributes
    {
        ...
        public DropDownAttribute(GH_Component owner,List<string> MenuNames,DropDownControl DropDown):base(owner)
        {
        ...
        protected override void Render(GH_Canvas canvas, Graphics graphics, GH_CanvasChannel channel)
        {
            ...
            if(channel == GH_CanvasChannel.Objects)
            {
                ...
                if (Grasshopper.CentralSettings.CanvasObjectIcons) this.DrawComponentName(graphics, false);
                else this.DrawComponentName(graphics, false);
        ...
        public override GH_ObjectResponse RespondToMouseDown(GH_Canvas sender, GH_CanvasMouseEvent e)
        {
            if(e.Button == MouseButtons.Left && !this.Owner.Locked)
            {
                ...
                {
                    this.DropDownControl.DropDownMenu.Show(sender,GH_Convert.ToPoint(e.ControlLocation));
                }
            }
